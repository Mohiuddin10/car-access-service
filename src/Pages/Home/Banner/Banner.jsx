    ...
    return (
        <div className="carousel w-full h-[600px]">
            <div id="slide1" className="carousel-item relative w-full">
                ...
                <div className="absolute rounded-xl flex items-center left-0 right-0 bottom-0 bg-gradient-to-r from-[#151515] to-[rgba(21,21,21,0)] h-full">
                    <div className="text-white space-y-7 pl-4 w-1/2">
                        ...
                        <div className="">
                            <button className="btn btn-active text-white bg-[#FF3811] mr-5">Neutral</button>
